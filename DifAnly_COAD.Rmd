---
title: "Differential Analysis - COAD (Colon)"
author: "Conor Loy"
date: "May 25, 2018"
output:
...
#### This R Markdown file performs miRNA differential expression analysis for the Colon Tissue Samples queried from the GDC API. Expression analysis is done with the edgeR and limma packages.
...
raw_rd <- read.csv("../../CleanData/COAD_rds.csv")
...
write.csv(temp, "../../CleanData/COAD_DifExp_outPut.csv")
```